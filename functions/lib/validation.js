...
// Validate ZIP code
exports.validateZipCode = functions.https.onCall(
...
// Validate email
exports.validateEmail = functions.https.onCall(
// eslint-disable-next-line @typescript-eslint/no-explicit-any
async (data) => {
    const schema = zod_1.z.object({
    ...
    try {
        ...
        // (in production, might check against email service)
...
exports.validatePhone = functions.https.onCall(
// eslint-disable-next-line @typescript-eslint/no-explicit-any
async (data) => {
    const schema = zod_1.z.object({
