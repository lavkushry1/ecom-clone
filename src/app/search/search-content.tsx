  ...
  const searchProducts = useCallback(async (searchQuery: string) => {
    ...
    try {
      ...
      if (selectedCategories.length > 0) {
        results = results.filter((product: Product) => selectedCategories.includes(product.category));
      }
      ...
      switch (sortBy) {
        case 'price_low':
          results.sort((a: Product, b: Product) => (a.salePrice || a.originalPrice) - (b.salePrice || b.originalPrice));
          break;
        case 'price_high':
          results.sort((a: Product, b: Product) => (b.salePrice || b.originalPrice) - (a.salePrice || a.originalPrice));
          break;
        case 'rating':
          results.sort((a: Product, b: Product) => b.ratings.average - a.ratings.average);
          break;
        default:
